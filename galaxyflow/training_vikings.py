...
import pandas as pd
from Handler.data_loader_viking import load_data
...
class TrainFlow(object):
    ...
    def __init__(self,
        ...
        self.path_output_flow = f"{self.path_output}/" \
                                f"lr_{self.lr}_" \
                                f"wd_{self.wd}_" \
    ...
    def init_dataset(self, path_training_data, selected_scaler):
        """"""
    ...
    def hyperparameter_tuning(self, config):
        ...
        self.train_loader, self.valid_loader, self.df_test, self.scaler = self.init_dataset(
            path_training_data=self.path_training_data,
