#!/bin/bash
#SBATCH --job-name=cf_new_training3
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=48:00:00
#SBATCH --mem=256G
#SBATCH -o /dss/dsshome1/04/di97tac/logs/cf_new_training3_%A.log
#SBATCH -e /dss/dsshome1/04/di97tac/logs/cf_new_training3_err_%A.log
#SBATCH --qos=mcml
