#!/bin/bash
#SBATCH --job-name=nf_test_training
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=48:00:00
#SBATCH --mem=256G
#SBATCH -o /dss/dsshome1/04/di97tac/logs/nf_test_training_%A.log
#SBATCH -e /dss/dsshome1/04/di97tac/logs/nf_test_training_err_%A.log
#SBATCH --qos=mcml
