#!/bin/bash
#SBATCH --job-name=cf_dashboard
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=48:00:00
#SBATCH --mem=128G
#SBATCH --chdir=/home/p/P.Gebhardt/development/GalaxyFlow/
#SBATCH -o /home/p/P.Gebhardt/Output/gaNdalF_classifier_training/cf_dashboard_%A.log
#SBATCH -e /home/p/P.Gebhardt/Output/gaNdalF_classifier_training/cf_dashboard_err_%A.log
